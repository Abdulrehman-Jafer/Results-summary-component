...
const Result = () => {
    return (
        <div className="bg-gradient-to-bl from-Light-slate-blue to-Light-royal-blue w-full md:rounded-3xl gap-[2rem] py-[2rem] md:py-[4rem] px-[2rem] flexCenter flex-col">
            <h4 className="text-Light-lavender text-2xl">Your Result</h4>
